...
<head>
    ...
    <style>
        ...
        /* --- Styling Konten (Contact Card & Form) --- */
        .main-content-area {
            padding: 20px;
        }
        .main-container {
            width: 100%;
            max-width: 800px; /* Adjusted max-width for contact layout */
            margin: 0 auto;
        }
...
<body>
    ...
    <script>
        ...
        // --- Script untuk Form (jika diperlukan) ---
        document.getElementById('contactForm').addEventListener('submit', function(e) {
            e.preventDefault();
            // Di sini Anda bisa menambahkan logika untuk mengirim form data
            // misalnya menggunakan fetch() ke backend API
